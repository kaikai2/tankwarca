...
protected:
    triangleIsCompleted &operator = (const triangleIsCompleted &rhs)
    {
        assert(0); // never call me please
        rhs;
        return *this;
    }
...
protected:
    vertexIsInCircumCircle &operator = (const vertexIsInCircumCircle &rhs)
    {
        assert(0); // never call me please
        rhs;
        return *this;
